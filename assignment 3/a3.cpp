...
void takeExits(Mouse exit[], int map[][20], int rows, int cols);
int mouseMove (Mouse &mouse, Mouse exit[], int matrix[][20], int moves[][20]);
void printMap(int map[][20], int rows, int cols, ofstream &fout);
void takeMap(Mouse &mouse, int map[][20], int &rows, int &cols, ifstream &fin);
